 ...
 */
@Singleton
public class BPublisherOld {

    private static final Logger log = LogManager.getLogger(BPublisherOld.class);
     ...
     */
    @Inject
    public BPublisherOld(ScheduledExecutorService scheduledExecutorService,
